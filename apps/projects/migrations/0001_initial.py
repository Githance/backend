    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_top_date', models.DateTimeField(auto_now_add=True, verbose_name='В топе последний раз')),
        ...
        migrations.AddField(
            model_name='project',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='projects', to='projects.projectstatus', verbose_name='Статус'),
        ),
        migrations.AddField(
            model_name='project',
            name='types',
            field=models.ManyToManyField(related_name='projects', through='projects.ProjectTypeProject', to='projects.ProjectType', verbose_name='Типы проекта'),
        ),
